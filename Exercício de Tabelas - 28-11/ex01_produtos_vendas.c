...
int menu_produtos ()
{
    ...
    do
    {
        ...
        printf("\n[1] Incluir produto");
        printf("\n[2] Alterar produto");
        printf("\n[3] Excluir produto (nao vendido)");
        printf("\n[4] Pesquisar produto pelo codigo");
        printf("\n[5] Comprar produto");
        printf("\n[6] Listar produtos");
        printf("\n[7] Apresentar balancete");
        printf("\n[8] Apresentar relacao dos produtos com estoque baixo");
        printf("\n[9] Cadastrar tabela de teste (10 produtos)");
...
int menu_vendas ()
{
    ...
    do
    {
        ...
        printf("\n[4] Apresentar quantidade de vendas por produto");
        printf("\n[5] Apresentar total arrecadado em um mes");
    ...
    do
    {
        if (menu_atual == 1)
        {
            ...
            case 1:
                ...
                if (tab_produtos_tl < TAB_PRODUTOS_TF)
                {
                    cadastrar_produto(tab_produtos, &tab_produtos_tl);
                    printf("\n>> Produto incluido com sucesso!\n");
                }
                else
                    printf("\n>> Nao e possivel cadastrar um novo produto.\n");
            ...
            case 2:
                ...
                if (tab_produtos_tl > 0)
                {
                    ...
                    {
                        alterar_produto(tab_produtos, tab_produtos_tl, cod_produto);
            ...
            case 5:
                ...
                if (tab_produtos_tl > 0)
                {
                    ...
                    if (cod_produto_existe(tab_produtos, tab_produtos_tl, cod_produto))
                    {
                        ...
                        printf("\n.. Insira a quantidade a ser comprada..: ");
                        scanf("%d", &qnt);

                        if (qnt > 0)
                        {
                            comprar_produto(tab_produtos, tab_produtos_tl, cod_produto, qnt);
            ...
            case 9:
                ...
                cadastrar_tab_produtos_teste(tab_produtos, &tab_produtos_tl);
                printf("\n>> Tabela de teste cadastrada com sucesso!\n");
